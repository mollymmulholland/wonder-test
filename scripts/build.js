...
for(const name of ['index.html','app.js','pool.js','editorial.css','journey.css','journey-ui.js','public-shared','assets'])fs.cpSync(path.join(__dirname,'..',name),path.join(dest,name),{recursive:true});

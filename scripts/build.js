...
for(const name of ['index.html','app.js','pool.js','editorial.css','journey.css','journey-ui.js','sanctuary.js','sanctuary.css','device-ui.js','operations-ui.js','manifest.webmanifest','service-worker.js','offline.html','public-shared','assets'])fs.cpSync(path.join(__dirname,'..',name),path.join(dest,name),{recursive:true});

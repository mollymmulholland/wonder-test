...
function fixture(){const users={};for(const [id,name,dob]of [['alex','Alex','1996-04-12'],['rowan','Rowan','1997-08-19']]){let s=initial();s.basics={name,dob,city:'Dallas, Texas'};s.consent={process:true,matching:true,research:false};s.preferences={intention:'A committed relationship',minAge:25,maxAge:40,cityRequired:true};s.portrait={bio:id==='alex'?'Curious by nature. Happiest with a long conversation and somewhere new to walk.':'I build things, read slowly, and take the scenic route home.',ordinary:'A gallery, a walk outdoors, and a meal made together.',care:'A clear plan and room to be myself.',interest:'Art, the outdoors, and the ideas a conversation uncovers.',photo:`assets/demo-${id}.svg`,approved:true};s.mirrorReviewed=true;s.availability='available';users[id]=s;}return {actor:'alex',users,pair:{id:'demo-introduction',members:['alex','rowan'],...pairState()},scenario:'normal'};}

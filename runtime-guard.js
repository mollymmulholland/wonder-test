(()=>{
  ...
  // iOS/Safari can occasionally swallow the synthetic click generated after a touch on dynamically re-rendered buttons.
  // Promote touchend directly to the existing assessment button handler and suppress the duplicate synthetic click.

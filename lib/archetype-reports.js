...
function reportFor(name) {
 ...
 return {name,sections:sections(w),lens_status:'provisional',version:VERSION,model_version:MODEL_VERSION,essence:a.essence,elements:a.elements,opening:w[0],gift:a.relational.gift,need:a.relational.need,shadow:a.relational.shadow,
